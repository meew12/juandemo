...
export async function POST(req: Request) {
  ...
  try {
    ...
    // Boost + Transaction have ALREADY been created in the DB above. Instead
    // of returning a 500, we return a 200 with `demo_mode: true` so the
    // frontend can route to the demo checkout page.
